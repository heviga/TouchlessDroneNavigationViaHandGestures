	 	...
	 	\begin{minipage}[b]{0.45\linewidth}
	 		...
	 		\begin{tikzpicture}[scale=0.75]
	 			\begin{axis}[
	 				...
	 				coordinates {
	 					(1,1) (1.5,1.5) (1,2) (2,1.5) (2, 2.5) (1.2, 3.5) (3, 1.2)
	 				};
	 				\addplot[
	 				only marks,
	 				color=red,
	 				...
	 				coordinates {
	 					(3,4) (4,3.5) (4,4.5) (3.5,3.5) (4,4) (3.5, 2.6) (2, 3.5) (2.6, 2.8) (1.8, 4.2) (4.1, 1.6)
	 				};
	 				\addplot[
	 				color=green,
	 				domain=0:5,
	 	...
	 	\begin{minipage}[b]{0.5\linewidth}
	 		...
	 		\begin{tikzpicture}[scale=0.75]
	 			\begin{axis}[
	 				...
	 				coordinates {
	 					(0.7,0.71) (1.5,1.5) (1.2,1.1) (2,1.5) (2.5, 0.4) (2.7, 1.2) (1.6, 0.3) (1.9, 0.6)
	 				};
	 				\addplot[
	 				only marks,
	 				color=red,
	 				...
	 				coordinates {
	 					(3,3.4) (4,3.5) (4,4.5) (3.5,3.5) (4, 1.6) (3.7, 2) (3.5, 2.7) (4.3, 2.3)
	 				};
	 				\addplot[
	 				only marks,
	 				color=green,
	 				...
	 				coordinates {
	 					(0.7, 3.4) (0.9, 2.9) (1.7, 2.7) (1.5, 3.2) (2, 3.3) (1.9, 4) (1.6, 3.9)
	 				};
	 				\addplot[
	 				color=green,
	 				domain=0:5,
